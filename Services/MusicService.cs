...
namespace StreamMusicBot.Services
{
    public class MusicService
    {
        ...
        public Task InitializeAsync()
        {
            ...
            _lavaNode.Log += LogAsync;
            _lavaNode.OnTrackFinished += TrackFinished;
            return Task.CompletedTask;
        }

        public async Task ConnectAsync(SocketVoiceChannel voiceChannel, ITextChannel textChannel)
            => await _lavaNode.ConnectAsync(voiceChannel, textChannel);

        public async Task LeaveAsync(SocketVoiceChannel voiceChannel)
            => await _lavaNode.DisconnectAsync(voiceChannel);
        ...
        {
            await _lavaNode.StartAsync(_client);
        }
